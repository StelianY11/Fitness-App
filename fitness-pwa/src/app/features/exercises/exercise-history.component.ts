  ...
  template: `
    <div class="space-y-5">
      <div class="flex items-start justify-between gap-4">
        <div>
          <p class="text-sm font-semibold text-green-700">Exercise History</p>
      ...
      @if (isLoading) {
        ...
        <div class="rounded-lg border border-red-200 bg-red-50 p-4">
          <p class="font-semibold text-red-800">Unable to load exercise history</p>
        ...
        <div class="rounded-lg border border-slate-200 bg-slate-50 p-5 text-center">
          <p class="font-semibold text-slate-800">No completed history yet</p>
        ...
        <section class="rounded-lg border border-green-200 bg-green-50 p-4">
          <p class="text-sm font-semibold text-green-800">Last workout</p>
